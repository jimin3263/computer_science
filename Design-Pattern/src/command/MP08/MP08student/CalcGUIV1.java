package command.MP08.MP08student;

import command.MP08.MP08student.command.ArithmeticOperatorCommandButton;
import command.MP08.MP08student.command.CommandButton;
import command.MP08.MP08student.command.EqualCommandButton;
import command.MP08.MP08student.command.NumButton;
...
public class CalcGUIV1 extends JFrame implements ActionListener {
    ...
    public JPanel getButtonPanel() {
        ...
        for (int i = 0; i < 10; i++) {
            buttons[i] = new NumButton(calculator, this);

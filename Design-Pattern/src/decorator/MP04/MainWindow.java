package decorator.MP04;

import decorator.MP04.deco.SpeedometerDisplay;
import decorator.MP04.deco.TimeDisplay;
import decorator.MP04.deco.WeatherDisplay;
import decorator.MP04.load.LoadHudDisplays;
...
public class MainWindow extends FrameWindow {
    ...
    public JPanel createPanel(int width, int height) {
        ...
        // 디스플레이마다 각각의 내용을 화면에 보임 -> speed 만 보임
        display.show();
        return panel;
    }
